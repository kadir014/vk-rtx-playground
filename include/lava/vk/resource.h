 ...
 */
typedef enum {
    LV_RESOURCE_FREQ_GLOBAL, /**< Per-frame scope resource (only `frame_lag` copies).
    ...
    LV_RESOURCE_FREQ_MATERIAL, /**< Per-material scope resource (as many copies as there are materials).
    ...
    LV_RESOURCE_FREQ_OBJECT, /**< Both per-model and per-frame scope resource (`frame_lag * amount_of_models` copies).
    ...
    LV_RESOURCE_FREQ_STATIC, /**< Constant immutable scope resource (no copies).
