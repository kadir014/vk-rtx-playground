...
void run_lvRefArray_tests(ttUnitTestSuite *test) {
    TT_RUN_TEST_P(test_lvRefArray_new);
    TT_RUN_TEST_P(test_lvRefArray_add);
    TT_RUN_TEST_P(test_lvRefArray_pop);
    TT_RUN_TEST_P(test_lvRefArray_remove);
    TT_RUN_TEST_P(test_lvRefArray_clear);
    TT_RUN_TEST_P(test_lvRefArray_copy);
    TT_RUN_TEST_P(test_lvRefArray_resize);
}